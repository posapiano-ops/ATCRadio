...
const bootstrapLayers = () => {
  ...
  addParticles(Math.floor(innerWidth / 20), Ohhhs2, createText('3'));
  addParticles(Math.floor(innerWidth / 50), Page, createText('Service Unavailable', { height: FONT_SIZE * 2, width: innerWidth }));
};
